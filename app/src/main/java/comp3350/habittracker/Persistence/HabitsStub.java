...
public class HabitsStub implements HabitsPersistence {
    ...
    public HabitsStub(){
        ...
        habits.add(new Habit("workout",5,3, new User("userA"),"Morning"));
        habits.add(new Habit("piano",7,1, new User("userA"),"Afternoon"));
        habits.add(new Habit("read",7,0, new User("userA"),"Morning"));
        habits.add(new Habit("run",2,0, new User("userA"),"Evening"));
    }
